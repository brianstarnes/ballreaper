...
typedef enum
{
	SWITCH_BACK_WALL_LEFT = 5,
	SWITCH_BACK_WALL_RIGHT = 6,
	SWITCH_SIDE_WALL_REAR = 1,
	SWITCH_SIDE_WALL_FRONT = 0,
	SWITCH_FRONT_WALL = 7
} switch_t;
...
{
	ENCODER_THRESHOLD_LEFT_LOW = 50,
	ENCODER_THRESHOLD_LEFT_HIGH = 800,
	ENCODER_THRESHOLD_RIGHT_LOW = 50,
	ENCODER_THRESHOLD_RIGHT_HIGH = 800
};
